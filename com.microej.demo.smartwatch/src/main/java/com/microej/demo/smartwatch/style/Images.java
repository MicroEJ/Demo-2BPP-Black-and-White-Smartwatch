 ...
 */
package com.microej.demo.smartwatch.style;
...
public interface Images {
	...
	/**
	 * The cond sequences. NOTE this array should be kept in sync with {@link com.microej.demo.smartwatch.model.FakeDataProvider#forecast} values
	 */
